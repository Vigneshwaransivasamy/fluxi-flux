...
fluxi-flux tries to implement the exact flux architectural pattern
...
# How to use?
 ...
 var boundAddTodo = 
  text => store.dispatch(addTodo(text));
 var boundSetVisibilityFilter = 
  index => store.dispatch(setVisibilityFilter(index));
